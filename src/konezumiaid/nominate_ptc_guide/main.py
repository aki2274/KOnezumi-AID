...
def nominate_candidate_stopcodon(
    ...
    editable_c_positions = transform_c_to_t_guideseq_to_position(transcript_recod.orf_seq, all_ct_guide_seq)
    # 8. transform ga guideseq to index
    editable_codon_T_positions = transform_g_to_a_guideseq_to_position(transcript_recod.orf_seq, all_ga_guide_seq)
