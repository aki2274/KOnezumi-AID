...
def filter_candidate(
    ...
    for cand in candidates:
        ...
        is_not_5UTR = target_exon_idx >= index_exon_with_5_utr
...
def search_site_candidate(
    ...
    acceptor_candidates = filter_candidate(acceptor_cands,index_exon_with_5_utr, index_exon_with_3_utr, exon_start_pos, exon_end_pos)
    donor_candidates = filter_candidate(donor_cands,index_exon_with_5_utr, index_exon_with_3_utr, exon_start_pos, exon_end_pos)
